...
class FilmorateApplicationTests {
	...
	public void testCreateAndUpdateUser() {
		Integer id = userDao.createUser(new User(null, "email@gmail.com", "login",
				"user", LocalDate.of(2000, 1, 1))).get();
		assertThat(userDao.getUserById(id)).isPresent()
	...
	public void testCreateAndUpdateFilm() {
		Integer id = filmDao.createFilm(new Film(null, "newFilm",
				"description film", LocalDate.of(2023, 5, 1), 120, 0,
				new Mpa(1, ""))).get();
		assertThat(filmDao.getFilmById(id))
				.isPresent()
